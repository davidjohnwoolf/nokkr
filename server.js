...
const { ACCOUNT_PATH, TEAM_PATH, USER_PATH, LEAD_FIELD_PATH, LEAD_STATUS_PATH, AREA_PATH, AREA_GROUP_PATH, LEAD_PATH } = require('./lib/constants');
...
app.use(LEAD_FIELD_PATH, LeadFields);
